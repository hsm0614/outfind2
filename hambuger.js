...
$(document).ready(function () {
    ...
    document.getElementById("sidebar-match-button").addEventListener("click", function() {
        console.log("Button clicked"); // 이 메시지가 콘솔에 나타나는지 확인
        const email = sessionStorage.getItem("email");
        const contractorEmail = sessionStorage.getItem("contractor-email");
    
        if (!email && !contractorEmail) {
            console.log("No login information, redirecting to login page");
