    ...
    $('#matching-management-button').click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log('매칭 정보:', response.matchingCompanies);
                // 매칭 정보를 화면에 표시
    ...
    function displayMatchingInfo(matchingCompanies) {
        ...
        if (matchingCompanies.length > 0) {
            ...
            matchingCompanies.forEach(function(company) {
                ...
                html += '<p class="card-text phone-info" style="display:none;">담당자 번호: ' + company.phone + '</p>';
